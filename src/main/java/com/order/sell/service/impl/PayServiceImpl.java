...
import com.order.sell.utils.JsonUtil;
import com.order.sell.utils.MathUtil;
...
public class PayServiceImpl implements PayService {
    ...
    public PayResponse create(OrderDTO orderDTO) {
        ...
        log.info("[make wechat payment]request={}", JsonUtil.toJson(payRequest));

        PayResponse payResponse = bestPayService.pay(payRequest);
        log.info("[make wechat payment]response={}", JsonUtil.toJson(payResponse));
        return payResponse;
    }
